...
<div class="container justify-content-center" style="width: 20%; padding: 3% 0 10% 0">
	...
	<form>
	  <div class="form-group">
	    ...
	    <button type="button" id="btn-email-enter" class="btn btn-outline-primary btn-sm mb-1 ml-2">인증번호발송</button>
	    <input type="email" name="email" class="form-control" placeholder="Enter email" id="email">
	  </div>
	</form>
	<div class="d-flex">
	  <input type="text" id="code" style="width: 30%; height: 38px;">
	  <button id="btn-code-enter" class="btn btn-primary ml-1">Enter</button>
	</div>
</div>
